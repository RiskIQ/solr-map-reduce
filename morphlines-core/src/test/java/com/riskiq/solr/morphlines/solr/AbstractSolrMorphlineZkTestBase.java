...
public abstract class AbstractSolrMorphlineZkTestBase extends SolrCloudTestCase {
  ...
  private static final File SOLR_CONF_DIR = new File(RESOURCES_DIR + "/com/riskiq/solr/morphlines/solr/collection1/conf");
  ...
  protected Command parse(String file, String collection) throws IOException {
    ...
    Config config = new org.kitesdk.morphline.base.Compiler().parse(new File(RESOURCES_DIR + "/" + file + ".conf"), locator.toConfig("SOLR_LOCATOR"));
