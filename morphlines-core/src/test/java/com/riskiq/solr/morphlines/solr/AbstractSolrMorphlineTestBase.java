 ...
 */
package com.riskiq.solr.morphlines.solr;
...
//  protected static final String EXTERNAL_SOLR_SERVER_URL = "http://127.0.0.1:8983/solr";
  ...
  protected static final String DEFAULT_BASE_DIR = "com/riskiq/solr/morphlines/solr";
    ...
    for (int i = 0; i < 1; i++) {
      ...
      for (String file : files) {
        ...
        if (expectedContents != null) {
          ...
          for (Entry<String, Object> entry : expectedContents.entrySet()) {
...
//      .setDocumentLoader(new CollectingDocumentLoader(100))
  ...
  private Config parse(String file) throws IOException {
    ...
    Config config = new org.kitesdk.morphline.base.Compiler().parse(morphlineFile, locator.toConfig("SOLR_LOCATOR"));
