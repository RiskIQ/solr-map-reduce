 ...
 */
package com.riskiq.solr.hadoop.morphline;
...
import com.riskiq.solr.hadoop.HdfsFileFieldNames;
import com.riskiq.solr.hadoop.PathParts;
import com.riskiq.solr.hadoop.Utils;
import com.riskiq.solr.morphlines.solr.DocumentLoader;
import com.riskiq.solr.morphlines.solr.SolrLocator;
import com.riskiq.solr.morphlines.solr.SolrMorphlineContext;
...
public final class MorphlineMapRunner {
  ...
  public MorphlineMapRunner(Configuration configuration, DocumentLoader loader, String solrHomeDir) throws IOException {
    ...
    morphline = new org.kitesdk.morphline.base.Compiler().compile(new File(morphlineFile), morphlineId, morphlineContext, null, override);
