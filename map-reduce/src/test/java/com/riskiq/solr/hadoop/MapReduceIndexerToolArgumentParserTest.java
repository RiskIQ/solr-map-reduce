...
import com.riskiq.solr.hadoop.hack.FileSystemThreadsFilter;
...
public class MapReduceIndexerToolArgumentParserTest extends SolrTestCaseJ4 {
  ...
  private static final File MINIMR_INSTANCE_DIR = new File(RESOURCES_DIR + "/com/riskiq/solr/morphlines/solr/minimr");
