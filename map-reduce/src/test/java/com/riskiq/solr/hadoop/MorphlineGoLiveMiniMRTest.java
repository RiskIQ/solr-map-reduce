...
import com.riskiq.solr.hadoop.hack.MiniMRClientCluster;
import com.riskiq.solr.hadoop.hack.MiniMRClientClusterFactory;
import com.riskiq.solr.morphlines.solr.AbstractSolrMorphlineTestBase;
...
public class MorphlineGoLiveMiniMRTest extends AbstractFullDistribZkTestBase {
  ...
  public static void setupClass() throws Exception {
    ...
    fileSystem.mkdirs(new Path("/org/apache/solr/hadoop/mapred/system"));
    fileSystem.setPermission(new Path("/tmp"),
        FsPermission.valueOf("-rwxrwxrwx"));
    fileSystem.setPermission(new Path("/user"),
        FsPermission.valueOf("-rwxrwxrwx"));
    fileSystem.setPermission(new Path("/org/apache/solr/hadoop/mapred/system"),
